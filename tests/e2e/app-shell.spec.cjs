...
test.describe('local application shell', () => {
  ...
  test('REG-UI-002: the packaged PWA manifest and app icons are available', async ({ page, request }) => {
    ...
    const manifest = await request.get('/manifest.webmanifest?v=4.0.89');
    ...
    for (const icon of ['assets/spray-wash-app-icon-192-v4.0.89.png', 'assets/spray-wash-app-icon-512-v4.0.89.png']) {
