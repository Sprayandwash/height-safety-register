...
test('NOTIFY-WEEKLY-BRAND-002: branded HTML preserves employee task-only content with a plain app reminder', () => {
  ...
  assert.match(edgeFunction, /Review and action your tasks in the Spray &amp; Wash Operations App/);
  assert.doesNotMatch(edgeFunction, /href=/);
