...
module.exports = defineConfig({
  ...
  testMatch: '**/admin-readonly-review.spec.cjs',
  fullyParallel: false,
  forbidOnly: true,
  retries: 0,
  ...
  projects: [
    { name: 'staging-admin-readonly-desktop', use: { ...devices['Desktop Chrome'] } },
    { name: 'staging-admin-readonly-mobile', use: { ...devices['Pixel 7'] } }
  ]
});
