/* Spray & Wash Operations App V4.0.60
...
(function(){
  ...
  function injectStyles(){
    ...
    const css = `
      ...
      .ops-shell{color:#28266f}
      .ops-btn,.ops-nav button{background:#edf6fc!important;border:1px solid #c2dcef!important;color:#302d7e!important;box-shadow:none}
      .ops-btn.primary,.ops-nav button.active,.ops-home-btn,.ops-home-tab{background:#302d7e!important;border-color:#302d7e!important;color:white!important}
      .ops-btn.ghost{background:white!important;border-color:#a9d2ed!important;color:#369bd5!important}
      ...
      .ops-table th,.ops-vehicle-asset-head,.ops-log-entry[open] summary,.ops-maintenance-choice,.ops-repeatable-maintenance,.ops-permission-check,.ops-question,.ops-check-section{background:#f6f9fe!important;border-color:#d9e2f0!important;color:#28266f}
      .ops-form input,.ops-form select,.ops-form textarea,.ops-filter-grid input,.ops-filter-grid select,.ops-log-filter input,.ops-log-filter select{border-color:#c5d8ee!important;color:#28266f}
      .ops-form input:focus,.ops-form select:focus,.ops-form textarea:focus,.ops-filter-grid input:focus,.ops-filter-grid select:focus{outline:3px solid rgba(54,155,213,.20);border-color:#369bd5!important}
      .ops-subtle,.ops-asset-meta{color:#61729b!important}
      .ops-role-chip,.ops-cert-search,.ops-transfer-card{background:#edf6fc!important;border-color:#a9d2ed!important;color:#302d7e!important}
      .ops-dashboard-stat,.ops-branch-card{box-shadow:0 14px 30px rgba(48,45,126,.18)!important}
      .ops-stat-total,.ops-home-height{background:linear-gradient(135deg,#302d7e,#369bd5)!important}
      .ops-stat-green,.ops-home-vehicle{background:linear-gradient(135deg,#00813a,#00a848)!important}
      .ops-stat-amber,.ops-home-management{background:linear-gradient(135deg,#302d7e,#369bd5)!important}
      .ops-stat-blue,.ops-home-admin{background:linear-gradient(135deg,#24215f,#302d7e)!important}
...
(function(){
  ...
  function install(){
    injectCss();
    document.querySelector('.tagline') && (document.querySelector('.tagline').textContent = 'Version 4.0.60 • Height Safety • Vehicle Checks • Equipment • Maintenance');
...
(function(){
  ...
  function cleanStaticV419(){
    const tagline = document.querySelector('.tagline'); if(tagline) tagline.textContent = 'Version 4.0.60 • Height Safety • Vehicle Checks • Equipment • Maintenance';
...
(function(){
  ...
  function init(){ injectCss(); document.querySelector('.tagline') && (document.querySelector('.tagline').textContent='Version 4.0.60 • Height Safety • Vehicle Checks • Equipment • Maintenance'); installRecent(); /* equipment register is owned by app.js */ installReports(); document.removeEventListener('click',closeAccountOutside); document.addEventListener('click',closeAccountOutside); window.SWOperationsV4=Object.assign(api(),{renderRecentHistoryV422:renderRecent,renderEquipmentFilteredListV422:renderEqList}); /* app.js owns window.renderEquipment */ }
...
(function(){
  ...
  function setVersion(){
    ...
    if(tagline) tagline.textContent = 'Version 4.0.60 • Height Safety • Vehicle Checks • Equipment • Maintenance';
...
(function(){
  ...
  function installCss(){
    ...
    const st=document.createElement('style'); st.id='sw424Styles'; st.textContent = `
      html[data-sw-version="4.0.60"] .notifyBtn,
      html[data-sw-version="4.0.60"] #notifyBadge,
      html[data-sw-version="4.0.60"] #notificationPanel{display:none!important}
  ...
  function setVersion(){
    document.documentElement.setAttribute('data-sw-version', VERSION);
    const t=document.querySelector('.tagline'); if(t) t.textContent='Version 4.0.60 • Height Safety • Vehicle Checks • Equipment • Maintenance';
  }
  async function loadHeight(){
