/* Spray & Wash Operations App V4.0.61
...
(function(){
  ...
  function injectStyles(){
    ...
    const css = `
      ...
      .ops-shell{color:#2d2f7c}
      .ops-btn,.ops-nav button{background:#edf6fc!important;border:1px solid #c2dcef!important;color:#2d2f7c!important;box-shadow:none}
      .ops-btn.primary,.ops-nav button.active,.ops-home-btn,.ops-home-tab{background:#2d2f7c!important;border-color:#2d2f7c!important;color:white!important}
      .ops-btn.ghost{background:white!important;border-color:#a9d2ed!important;color:#349bd6!important}
      ...
      .ops-table th,.ops-vehicle-asset-head,.ops-log-entry[open] summary,.ops-maintenance-choice,.ops-repeatable-maintenance,.ops-permission-check,.ops-question,.ops-check-section{background:#f6f9fe!important;border-color:#d9e2f0!important;color:#2d2f7c}
      .ops-form input,.ops-form select,.ops-form textarea,.ops-filter-grid input,.ops-filter-grid select,.ops-log-filter input,.ops-log-filter select{border-color:#c5d8ee!important;color:#2d2f7c}
      .ops-form input:focus,.ops-form select:focus,.ops-form textarea:focus,.ops-filter-grid input:focus,.ops-filter-grid select:focus{outline:3px solid rgba(52,155,214,.20);border-color:#349bd6!important}
      .ops-subtle,.ops-asset-meta{color:#61729b!important}
      .ops-role-chip,.ops-cert-search,.ops-transfer-card{background:#edf6fc!important;border-color:#a9d2ed!important;color:#2d2f7c!important}
      .ops-dashboard-stat,.ops-branch-card{box-shadow:0 14px 30px rgba(48,45,126,.18)!important}
      .ops-stat-total,.ops-home-height{background:#2d2f7c!important}
      .ops-stat-green,.ops-home-vehicle{background:#148f54!important}
      .ops-stat-amber,.ops-home-management{background:#349bd6!important}
      .ops-stat-blue,.ops-home-admin{background:#2d2f7c!important}
...
(function(){
  ...
  function install(){
    injectCss();
    document.querySelector('.tagline') && (document.querySelector('.tagline').textContent = 'Version 4.0.61 • Height Safety • Vehicle Checks • Equipment • Maintenance');
...
(function(){
  ...
  function cleanStaticV419(){
    const tagline = document.querySelector('.tagline'); if(tagline) tagline.textContent = 'Version 4.0.61 • Height Safety • Vehicle Checks • Equipment • Maintenance';
...
(function(){
  ...
  function init(){ injectCss(); document.querySelector('.tagline') && (document.querySelector('.tagline').textContent='Version 4.0.61 • Height Safety • Vehicle Checks • Equipment • Maintenance'); installRecent(); /* equipment register is owned by app.js */ installReports(); document.removeEventListener('click',closeAccountOutside); document.addEventListener('click',closeAccountOutside); window.SWOperationsV4=Object.assign(api(),{renderRecentHistoryV422:renderRecent,renderEquipmentFilteredListV422:renderEqList}); /* app.js owns window.renderEquipment */ }
...
(function(){
  ...
  function setVersion(){
    ...
    if(tagline) tagline.textContent = 'Version 4.0.61 • Height Safety • Vehicle Checks • Equipment • Maintenance';
...
(function(){
  ...
  function installCss(){
    ...
    const st=document.createElement('style'); st.id='sw424Styles'; st.textContent = `
      html[data-sw-version="4.0.61"] .notifyBtn,
      html[data-sw-version="4.0.61"] #notifyBadge,
      html[data-sw-version="4.0.61"] #notificationPanel{display:none!important}
  ...
  function setVersion(){
    document.documentElement.setAttribute('data-sw-version', VERSION);
    const t=document.querySelector('.tagline'); if(t) t.textContent='Version 4.0.61 • Height Safety • Vehicle Checks • Equipment • Maintenance';
  }
  async function loadHeight(){
