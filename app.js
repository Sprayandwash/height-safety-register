...
function renderReportsHome(){if(!requirePerm(canExport(),"Only Admin, Office / Reports or Certificate Approver users can view reports."))return;fillReportFilterOptions(); if(!currentReport.rows.length) runReport("equipment_register");}
